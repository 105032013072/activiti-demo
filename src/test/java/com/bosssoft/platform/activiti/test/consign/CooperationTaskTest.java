...
public class CooperationTaskTest extends AbstractTaskTest{
	...
	public void commonTask() throws Exception{
	    ...
	    // taskService.claimCascade(btaskId, bConsignStr, "u04");
	     ...
	     taskService.claimCascade(ataskId, getConsignInstIdForClaim(ataskId, "u02"), "u02");
		 taskService.claimCascade(btaskId, getConsignInstIdForClaim(btaskId, "u04"), "u04");
	     ...
	     taskService.completCascade(ataskId, getConsignInstIdForComplete(ataskId));
	     taskService.completCascade(btaskId, getConsignInstIdForComplete(btaskId));
	   ...
	   //  taskService.completCascade(ataskId, aConsignStr);
	    // taskService.redo(bConsignStr);
	     ...
	     taskService.completCascade(ataskId, getConsignInstIdForComplete(ataskId));
		  taskService.redo(getConsignInstIdForRedo(btaskId));
	...
	public void delegateTask() throws Exception{
	  ...
	  //   taskService.completCascade(taskId, consignStr);
	     ...
	     taskService.claimCascade(taskId, getConsignInstIdForClaim(taskId, "u03"), "u03");
		  taskService.completCascade(taskId, getConsignInstIdForComplete(taskId));
	...
	public void subsitutionTask() throws Exception{
		...
		taskService.claimCascade(ataskId, getConsignInstIdForClaim(ataskId, "u02"),"u02");
		taskService.claimCascade(btaskId, getConsignInstIdForClaim(btaskId, "u05"),"u05");
		...
		taskService.claimCascade(ataskId, getConsignInstIdForClaim(ataskId, "u04"),"u04");
		taskService.claimCascade(btaskId, getConsignInstIdForClaim(btaskId, "u06"),"u06");
		...
		taskService.completCascade(ataskId, getConsignInstIdForComplete(ataskId));
		taskService.unclaimCascade(btaskId, getConsignInstIdForUmClaim(btaskId, "u05"));
	...
	public void cooperationCancel() throws Exception{
		...
		//	taskService.claimCascade(btaskId, bcooInstidOne,"u05");
           ...
           // taskService.redo(acooInstidOne);
			taskService.redo(getConsignInstIdForRedo(ataskId));
