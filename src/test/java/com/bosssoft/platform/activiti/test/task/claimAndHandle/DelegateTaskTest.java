...
public class DelegateTaskTest extends AbstractTaskTest{
	...
	//	taskService.claimAndHandle(btask.getTaskId(), "u04", btask.getConsigInstId(), null);
		...
		//taskService.claimAndHandle(ctask.getTaskId(), "u06", ctask.getConsigInstId(), null);
	...
	public void sourceDelegate() throws Exception{
	   ...
	   //待办任务查询
	   TaskVerifyEntity verifyEntity=new TaskVerifyEntity("B", TaskBusinessState.DELEGATE.toString(), ConsignInstState.UNFINISH.toString(), null, true, true);
	   ...
	   verifyEntity=new TaskVerifyEntity("C", TaskBusinessState.DELEGATE.toString(), ConsignInstState.UNFINISH.toString(), "u08", true, false);
	   ...
	   verifyEntity=new TaskVerifyEntity("B", TaskBusinessState.DELEGATE.toString(), ConsignInstState.FINISHED.toString(), "u04", true, false);
	   ...
	   verifyEntity=new TaskVerifyEntity("C", TaskBusinessState.DELEGATE.toString(), ConsignInstState.FINISHED.toString(), "u08", true, false);
	   ...
	   verifyEntity=new TaskVerifyEntity("D", TaskBusinessState.DELEGATE.toString(), ConsignInstState.UNFINISH.toString(), "u08", true, false);
	    verifyEntity2=new TaskVerifyEntity("C", TaskBusinessState.DELEGATE.toString(), ConsignInstState.FINISHED.toString(), "u08", true, false);
